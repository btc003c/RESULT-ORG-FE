...
// Mock historical imports
const INITIAL_QUEUE = [
  { id: "job-1", filename: "tnpsc-group-iv-eligible.csv", datasetName: "TNPSC Group IV Results 2026", size: "4.8 MB", progress: 100, status: "Success", rows: 42350, errors: 0, date: "10 mins ago" },
];
  ...
  const startIngestionSimulator = async () => {
    ...
    try {
      ...
      const newJob = {
        ...
        datasetName: targetDataset ? targetDataset.name : "Dataset",
        size: selectedFile.size,
        progress: 100,
        status: "Success",
        rows: response.rowsProcessed || 0,
        errors: 0,
        date: "Just now",
      };
